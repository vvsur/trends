...
export type StrategicInitiativeItem = components['schemas']['StrategicInitiativeItem'];
export type StrategicInitiativeListResponse = components['schemas']['StrategicInitiativeListResponse'];
