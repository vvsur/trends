...
| `docs/03-product-concept.md` | Модули портала, MVP, ручное управление, домены, value scorecard, employee value, MOEX DS и стек покрыты TR-001..TR-006, TR-010..TR-026, TR-040..TR-056, TR-073..TR-078, TR-090..TR-098, TR-100..TR-102 |
| `docs/05-data-model.md` | Сущности данных покрыты implementation tasks TR-300..TR-308, TR-336..TR-337, TR-354..TR-355 |
...
| `docs/07-architecture.md` | Закрытый/открытый контур, стек, validation, импорт, безопасность и этапы развертывания покрыты TR-090..TR-098, TR-120..TR-125, TR-200..TR-207, TR-380..TR-386 |
...
| `docs/11-technology-stack.md` | React frontend, TypeScript backend и ADR по framework/runtime покрыты TR-102, TR-120, TR-121, TR-122 |
| `docs/12-implementation-readiness-review.md` | Предстартовые решения и первый implementation slice покрыты TR-100, TR-120..TR-127, TR-200..TR-207 |
...
После добавления TR-025, TR-026, TR-046, TR-047, TR-078, TR-084, TR-098, TR-116 и соответствующих implementation tasks документация покрыта backlog достаточно для старта реализации. Следующий риск не в полноте backlog, а в архитектурных решениях перед кодом: TR-100, TR-120, TR-121, TR-122, TR-123, TR-124, TR-125.
