...
Ограничение по стеку для будущей реализации: frontend на React, backend на TypeScript. Для frontend MVP выбран Vite + React + TypeScript SPA, решение зафиксировано в `docs/adr/0001-frontend-build-tool.md`.
